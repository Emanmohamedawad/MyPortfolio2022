const data = [
    ...
    //   image: "https://img.icons8.com/ios/40/000000/open-book.png",
      title: "UI/UX Design",
      desc: "Creating website or Application design with user-experience and user-interface by using XD.",
    },
    {
      id: 3,
    //   image: "https://img.icons8.com/fluency-systems-regular/64/000000/retro-tv.png ",
      title: "Dapp Development web3(Blockchain)",
      desc: "Building dapp site integrate with Blockchain contracts by using web3.js.",
    },
    // {
    //   id: 4,
