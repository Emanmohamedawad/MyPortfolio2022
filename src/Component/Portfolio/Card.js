    ...
    <>
      <div className='box btn_shadow '>
        ...
        <div className='category d_flex'>
          ...
          <label>
            <i className='far fa-heart'></i> {props.src}
          </label>
        </div>
        <div className='title'>
          {/* <h2 onClick={toggleModal}>{props.title}</h2> */}
          <h2>{props.title}</h2>
          <a href='#popup' className='eye' onClick={toggleModal}>
          {/* <a href='https://github.com/Emanmohamedawad?tab=repositories' className='eye'> */}
